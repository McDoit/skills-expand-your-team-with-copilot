document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter: if a specific level is selected, hide activities
      // that have a different difficulty set (activities with no difficulty are shown for all levels)
      if (currentDifficulty !== "") {
        const activityDifficulty = details.difficulty || "";
        if (activityDifficulty !== currentDifficulty && activityDifficulty !== "") {
          return;
        }
      }
